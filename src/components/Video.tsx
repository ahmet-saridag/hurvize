...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <Container>
      <div className="relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-indigo-300 cursor-pointer bg-gradient-to-tr ">
        {!playVideo && (
          <>
            <Image
              src="/img/assets/hangi-konularda-hizmet.jpeg"
              alt="N"
              width="500"
              height="500"
